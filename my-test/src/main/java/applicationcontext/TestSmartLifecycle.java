...
public class TestSmartLifecycle implements SmartLifecycle, DisposableBean {

	@Override
	public void destroy() throws Exception {
		System.out.println("TestSmartLifecycle destroy");
	}
	...
	public void stop(Runnable callback) {
		System.out.println("TestSmartLifecycle stop(Runnable)");
